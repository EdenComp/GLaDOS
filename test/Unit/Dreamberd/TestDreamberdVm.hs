...
testEnvDefinesAndRedefines =
    TestList
        ...
        , TestCase $ execVM [Push (VM.Integer 1), Push (VM.Integer 2), Push (VM.Bool True), DefineEnv "fst" Define Nothing, DefineEnv "sec" Define Nothing, DefineEnv "neq" Define Nothing, PushEnv "sec", Ret] >>= assertEqual "wipe stack" (Right (VM.Integer 2))
