...
-- testParseDreamberd =
--     TestList
--         [ TestCase (assertEqual "parseDreamberd basic assign var" (Right [Call "=" [String "int", Identifier "a", Number 1]]) (parseDreamberd $ File "unit test" "int a = 1;"))
--         , TestCase (assertEqual "parseDreamberd reasign var and call function" (Right [Call "=" [String "int", Identifier "a", Number 1], Call "=" [Identifier "a", Number 2], Call "fct" []]) (parseDreamberd (File "unit test" "int a = 1;a = 2;fct();")))
--         , TestCase (assertEqual "parseDreamberd wrong assign var value" (Left "No '=' found for variable assignment") (parseDreamberd $ File "unit test" "int a 1; "))
--         , TestCase (assertEqual "parseDreamberd wrong boolean value" (Left "No boolean found") (parseDreamberd $ File "unit test" "bool a=42; "))
--         , TestCase (assertEqual "parseDreamberd empty code" (Right []) (parseDreamberd $ File "unit test" "     "))
--         , TestCase (assertEqual "parseDreamberd invalid variable name" (Left "No variable name found") (parseDreamberd $ File "unit test" "int * = 4;"))
--         , TestCase (assertEqual "parseDreamberd basic loop" (Right [Loop (Boolean True) [Call "=" [String "int", Identifier "b", Number 42]] Nothing Nothing]) (parseDreamberd $ File "unit test" "while (true) {int b = 42;}"))
--         , TestCase (assertEqual "parseDreamberd wrong var type" (Left "Unrecognized element") (parseDreamberd $ File "unit test" "fluid variable = 89;"))
--         , TestCase (assertEqual "parseDreamberd strange function call with parenthesis" (Right [Call "a" [String "lo()l)", Call "b" [Call "c" [String "()"]]]]) (parseDreamberd $ File "unit test" "a(\"lo()l)\", b(c(\"()\")));"))
--         , TestCase (assertEqual "parseDreamberd define var, += and return it" (Right [Call "=" [String "int", Identifier "i", Number 0], Call "+=" [Identifier "i", Number 1], Return (Identifier "i")]) (parseDreamberd $ File "unit test" "int i=0;i+=1;return i;"))
--         ]
