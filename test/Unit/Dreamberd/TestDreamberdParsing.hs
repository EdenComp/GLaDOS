    ...
    TestList
        ...
        , TestCase
            ( assertEqual
                ...
                (Right [Function "strcmp" ["str1", "str2"] [If (Call (Identifier "==") [Identifier "str1", String ""]) [If (Call (Identifier "==") [Identifier "str2", String ""]) [Return $ Just $ Integer 0] [Return $ Just $ Call (Identifier "-") [Integer 1]]] [If (Call (Identifier "==") [Identifier "str2", String ""]) [Return $ Just $ Integer 1] [If (Call (Identifier "==") [Call (Identifier "substr") [Identifier "str1", Integer 0, Integer 1], Call (Identifier "substr") [Identifier "str2", Integer 0, Integer 1]]) [Return $ Just $ Call (Identifier "strcmp") [Call (Identifier "substr") [Identifier "str1", Integer 1], Call (Identifier "substr") [Identifier "str2", Integer 1]]] [If (Call (Identifier "<") [Call (Identifier "substr") [Identifier "str1", Integer 0, Integer 1], Call (Identifier "substr") [Identifier "str2", Integer 0, Integer 1]]) [Return $ Just $ Call (Identifier "-") [Integer 1]] [Return $ Just $ Integer 1]]]]]])
