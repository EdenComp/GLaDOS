...
testDreamberdParsing = TestList [testParseFunction, testParseFunctionCall, testParseCondition, testParseOperator, testParseConditionExpression, testParseDreamberd]
