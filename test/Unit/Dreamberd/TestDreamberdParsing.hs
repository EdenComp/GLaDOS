...
testParseFunction =
    TestList
        ...
        , TestCase (assertEqual "parseFunction nested" (Right ("", [Function "foo" [] [Function "bar" [] [Call "=" [String "bool", Identifier "b", Boolean True]], Return (Number 1)]])) (parseFunction "foo(){ function bar() {bool b=true;} return 1;}" []))
