...
testTypesTranspilation =
    TestList
        ...
        , TestCase $ assertEqual "Transpile String 2" (transpileString "World") "\x00\x00\x00\x05World"
        ...
        , TestCase $ assertEqual "Transpile Call FunctionName" (transpileCall (FunctionName "test")) "\x22\x00\x00\x00\x04test"
