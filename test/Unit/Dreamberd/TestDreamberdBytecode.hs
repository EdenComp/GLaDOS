...
import Dreamberd.Bytecode.Encode (transpileCall, transpileInt, transpileString, transpileInstruction, transpileIntoBytecode)
import Dreamberd.Vm
...
testTranspileInt = TestLabel "transpileInt" $ TestList
...
testTranspileString = TestLabel "transpileString" $ TestList
...
testTranspileCall = TestLabel "transpileCall" $ TestList
...
testTranspileInstruction = TestLabel "transpileInstruction" $ TestList
...
testTranspileIntoBytecode = TestLabel "transpileBytecode" $ TestList
