...
testTranspilation =
    TestList
        [ TestCase $ assertEqual "basic bytecode" (transpileIntoBytecode [Push (Number 1), Ret]) "db4\n\x01\x11\x00\x00\x00\x00\x00\x00\x00\x01\x08\n"
